...
def downgrade() -> None:
    ...
    op.create_index(
        "ix_content_items_publish_date", "content_items", ["publish_date"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_internal_links_target", "internal_links", ["target_id"], unique=False
    )
    op.create_index(
        "ix_internal_links_source", "internal_links", ["source_id"], unique=False
    )
    op.create_table(
        "clusters",
        sa.Column("id", sa.INTEGER(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "clicks", sa.INTEGER(), server_default=sa.text("'0'"), nullable=False
        ),
        sa.Column(
            "impressions", sa.INTEGER(), server_default=sa.text("'0'"), nullable=False
        ),
